...
STRINGS = {
    'zh': {
        ...
        'proxy_help': '支援 HTTP、HTTPS、SOCKS4、SOCKS5；省略協定時預設使用 HTTP。設定會立即套用，無須重開。',
    ...
    'en': {
        ...
        'proxy_help': 'Supports HTTP, HTTPS, SOCKS4, and SOCKS5. HTTP is used when the scheme is omitted. Changes apply immediately.',
    ...
    'zh-Hans': {
        ...
        'proxy_help': '支持 HTTP、HTTPS、SOCKS4、SOCKS5；省略协议时默认使用 HTTP。设置立即生效，无需重启。',
    ...
    'ja': {
        ...
        'proxy_help': 'HTTP、HTTPS、SOCKS4、SOCKS5 に対応。スキーム省略時は HTTP。変更は再起動なしですぐ反映されます。',
